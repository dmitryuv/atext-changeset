 ...
 *
 * @param {Changeset} otherCS
 * @param {string} side - 'left' or 'right' (see explanation above)
 * @returns {Changeset} - new transformed Changeset object
 */
 ...
 *
 * @param {Changeset} otherCS
 * @returns {Changeset} - new composed Changeset object
 */
 ...
 *
 * @returns {Changeset} - new inverted Changeset object
 */
 ...
 *
 * @param {ADocument} doc
 * @returns {ADocument} doc - the same document instance (but modified) that was passed in so you can chain the calls.
 */
