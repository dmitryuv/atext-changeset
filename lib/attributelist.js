...
/*
 * Add format opcode to the list. That means key and value should be added as an attribute
 *
 * @param {string} key
 * @param {string} value
 * @returns {AttributeList} so you can chain the calls
 */
...
/*
 * Add remove opcode to the list. That means key and value should be removed from the attributes
 *
 * @param {string} key
 * @param {string} value
 * @returns {AttributeList} so you can chain the calls
...
/*
 * Create a copy of the attribute list. Note that OpAttribute objects (members of the list) are not cloned
 * for speed reasons, that means they are immutable.
 */
...
/*
 * @returns {Boolean} true if this list is empty
 */
 ...
 *
 * @param {AttributeList} otherAtts
 * @returns {AttributeList} newly created attribute list with merged result
 */
 ...
 *
 * @param {AttributeList} otherAtts
 * @param {Boolean} isComposition - defines behaviour of the method
 * @returns {AttributeList} newly created AttributeList with composed result
 */
 ...
 *
 * @param {AttributeList} otherAtts
 * @returns {AttributeList} newly created AttributeList with transformed result
 */
 ...
 *
 * @param {AttributeList} otherAtts
 * @returns {AttributeList} newly created AttributeList with formatted result
 */
